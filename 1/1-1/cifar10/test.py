...
from model import CNN_CIFAR_300K
from utils import cifar10_train_model
...
# CNN
model = CNN_CIFAR_300K()
cifar10_train_model(model, train_loader, test_loader, num_epochs=50, lr=0.003, save_path='model_cnn.ckpt')
